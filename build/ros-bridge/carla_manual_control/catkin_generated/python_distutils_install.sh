...
echo_and_run cd "/home/zhy/carla-ros-bridge/qzhq_ws/src/ros-bridge/carla_manual_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/zhy/carla-ros-bridge/qzhq_ws/src/ros-bridge/carla_manual_control/setup.py" \
     \
    build --build-base "/home/zhy/carla-ros-bridge/qzhq_ws/build/ros-bridge/carla_manual_control" \
    install \
    --root="${DESTDIR-/}" \
