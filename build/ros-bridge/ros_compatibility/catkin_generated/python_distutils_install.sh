...
echo_and_run cd "/home/zhy/carla-ros-bridge/qzhq_ws/src/ros-bridge/ros_compatibility"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/zhy/carla-ros-bridge/qzhq_ws/src/ros-bridge/ros_compatibility/setup.py" \
     \
    build --build-base "/home/zhy/carla-ros-bridge/qzhq_ws/build/ros-bridge/ros_compatibility" \
    install \
    --root="${DESTDIR-/}" \
